...
public static class ManageNavPages
{
    ...
    ///     directly from your code. This API may change or be removed in future releases.
    /// </summary>
    public static string UpsertExhibitor => "RegisterExhibitor";
    ...
    ///     directly from your code. This API may change or be removed in future releases.
    /// </summary>
    public static string RegisterExhibitorNavClass(ViewContext viewContext)
    {
        return PageNavClass(viewContext, UpsertExhibitor);
    }

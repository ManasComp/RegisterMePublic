...
public static class CreateUser
{
        ...
        UserManager<ApplicationUser> userManager, IdentityRole administratorRole)
    {
        ...
        if (userManager.Users.All(u => u.UserName != superAdministrator.UserName))
        {
            ...
            {
                await userManager.AddToRolesAsync(superAdministrator, new[] { administratorRole.Name });
            }
        }
    ...
    public static ApplicationUser CreateTestOrganizationAdministrator()
    {
        ...
        {
            UserName = "ondrejman1@gmail.com", // todo change this in the production
            Email = "ondrejman1@gmail.com", // todo change this in the production

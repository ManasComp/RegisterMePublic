...
public static class CreateExhibition
{
        ...
        TimeProvider dateTime, List<Group> groups, bool published, int organizationId)
    {
        ...
        exhibition.Email = "ondrejman1@gmail.com";
        exhibition.Iban = "CZ1701000000432828900227";
        exhibition.BankAccount = "43-2828900227/0100";
        ...
        {
            PriceEur = 30, PriceKc = 700, Groups = groups_1_3_5_7_9, ExhibitionDays = { day1 }
        };
        Price price2_1_3_5_7_9 = new()
        {
            PriceEur = 50, PriceKc = 1200, Groups = groups_1_3_5_7_9, ExhibitionDays = { day1, day2 }
        };
        Price price3_1_3_5_7_9 = new()
        {
            PriceEur = 30, PriceKc = 700, Groups = groups_1_3_5_7_9, ExhibitionDays = { day2 }
        };
        ...
        {
            PriceEur = 30, PriceKc = 700, Groups = groups_2_4_6_8_10_11_12, ExhibitionDays = { day1 }
        };
        Price price2_2_4_6_8_10_11_12 = new()
        {
            PriceEur = 50, PriceKc = 1200, Groups = groups_2_4_6_8_10_11_12, ExhibitionDays = { day1, day2 }
        };
        Price price3_2_4_6_8_10_11_12 = new()
        {
            PriceEur = 30, PriceKc = 700, Groups = groups_2_4_6_8_10_11_12, ExhibitionDays = { day2 }
        };
        ...
        List<Group> groups_13 = groups.Where(x => x.GroupId is "13a" or "13b" or "13c")
            .ToList();
        Price price1_13 = new() { PriceEur = 0, PriceKc = 0, Groups = groups_13, ExhibitionDays = { day1 } };
        Price price2_13 = new() { PriceEur = 0, PriceKc = 0, Groups = groups_13, ExhibitionDays = { day1, day2 } };
        Price price3_13 = new() { PriceEur = 0, PriceKc = 0, Groups = groups_13, ExhibitionDays = { day2 } };
        ...
        Price price1_14 = new() { PriceEur = 25, PriceKc = 600, Groups = groups_14, ExhibitionDays = { day1 } };
        Price price2_14 = new() { PriceEur = 40, PriceKc = 1000, Groups = groups_14, ExhibitionDays = { day1, day2 } };
        Price price3_14 = new() { PriceEur = 25, PriceKc = 600, Groups = groups_14, ExhibitionDays = { day2 } };
        context.Prices.Add(price1_14);
        context.Prices.Add(price2_14);
        context.Prices.Add(price3_14);

        Price price1_15 = new() { PriceEur = 10, PriceKc = 600, Groups = groups_15, ExhibitionDays = { day1 } };
        Price price2_15 = new() { PriceEur = 10, PriceKc = 1000, Groups = groups_15, ExhibitionDays = { day1, day2 } };
        Price price3_15 = new() { PriceEur = 10, PriceKc = 600, Groups = groups_15, ExhibitionDays = { day2 } };
        context.Prices.Add(price1_15);
        context.Prices.Add(price2_15);
        context.Prices.Add(price3_15);

        Price price1_16 = new() { PriceEur = 35, PriceKc = 800, Groups = groups_16, ExhibitionDays = { day1 } };
        Price price2_16 = new() { PriceEur = 60, PriceKc = 1400, Groups = groups_16, ExhibitionDays = { day1, day2 } };
        Price price3_16 = new() { PriceEur = 35, PriceKc = 800, Groups = groups_16, ExhibitionDays = { day2 } };
        context.Prices.Add(price1_16);
        context.Prices.Add(price2_16);
        context.Prices.Add(price3_16);

        Price price1_17 = new() { PriceEur = 25, PriceKc = 400, Groups = groups_17, ExhibitionDays = { day1 } };
        Price price2_17 = new() { PriceEur = 40, PriceKc = 700, Groups = groups_17, ExhibitionDays = { day1, day2 } };
        Price price3_17 = new() { PriceEur = 25, PriceKc = 400, Groups = groups_17, ExhibitionDays = { day2 } };
        ...
        const string catRegistrationWorkflow = """
                                               ...
                                               """;
        IEnumerable<MyWorkflow> catRegistrationWorkflows =
            (JsonConvert.DeserializeObject<List<Workflow>>(catRegistrationWorkflow) ?? [])
            .Select(x => new MyWorkflow(x, exhibition.Id));

        context.MyWorkflows.AddRange(catRegistrationWorkflows);
        ...
        int organizationId)
    {
        ...
        exhibition.Email = "brnokocky@gmail.com"; // todo change to showkockybrno@seznam.cz
        ...
        {
            PriceEur = 30, PriceKc = 700, Groups = groups_1_to_12, ExhibitionDays = { day1 }
        };
        Price price2_1_to_12 = new()
        {
            PriceEur = 50, PriceKc = 1100, Groups = groups_1_to_12, ExhibitionDays = { day1, day2 }
        };
        Price price3_1_to_12 = new()
        {
            PriceEur = 30, PriceKc = 700, Groups = groups_1_to_12, ExhibitionDays = { day2 }
        };
        ...
        List<Group> groups_14 = groups.Where(x => x.GroupId == "14").ToList();
        Price price1_14 = new() { PriceEur = 15, PriceKc = 300, Groups = groups_14, ExhibitionDays = { day1 } };
        Price price2_14 = new() { PriceEur = 20, PriceKc = 500, Groups = groups_14, ExhibitionDays = { day1, day2 } };
        Price price3_14 = new() { PriceEur = 15, PriceKc = 300, Groups = groups_14, ExhibitionDays = { day2 } };
        context.Prices.Add(price1_14);
        context.Prices.Add(price2_14);
        context.Prices.Add(price3_14);
        ...
        List<Group> groups_15 = groups.Where(x =>
            x.GroupId == "15").ToList();
        Price price1_15 = new() { PriceEur = 15, PriceKc = 300, Groups = groups_15, ExhibitionDays = { day1 } };
        Price price2_15 = new() { PriceEur = 20, PriceKc = 500, Groups = groups_15, ExhibitionDays = { day1, day2 } };
        Price price3_15 = new() { PriceEur = 15, PriceKc = 300, Groups = groups_15, ExhibitionDays = { day2 } };
        context.Prices.Add(price1_15);
        context.Prices.Add(price2_15);
        context.Prices.Add(price3_15);
        ...
        List<Group> groups_16 = groups.Where(x =>
            x.GroupId == "16").ToList();
        Price price1_16 = new() { PriceEur = 35, PriceKc = 800, Groups = groups_16, ExhibitionDays = { day1 } };
        Price price2_16 = new() { PriceEur = 55, PriceKc = 1400, Groups = groups_16, ExhibitionDays = { day1, day2 } };
        Price price3_16 = new() { PriceEur = 35, PriceKc = 800, Groups = groups_16, ExhibitionDays = { day2 } };
        context.Prices.Add(price1_16);
        context.Prices.Add(price2_16);
        context.Prices.Add(price3_16);
        ...
        List<Group> groups_17 = groups.Where(x =>
            x.GroupId == "17").ToList();
        Price price1_17 = new() { PriceEur = 25, PriceKc = 300, Groups = groups_17, ExhibitionDays = { day1 } };
        Price price2_17 = new() { PriceEur = 40, PriceKc = 500, Groups = groups_17, ExhibitionDays = { day1, day2 } };
        Price price3_17 = new() { PriceEur = 25, PriceKc = 300, Groups = groups_17, ExhibitionDays = { day2 } };
        context.Prices.Add(price1_17);
        context.Prices.Add(price2_17);
        context.Prices.Add(price3_17);

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PriceKc = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    Description = table.Column<string>(type: "text", nullable: false),
                    PriceCzk = table.Column<decimal>(type: "numeric", nullable: false),
                    PriceEur = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyWorkflows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MyWorkflows_Exhibitions_ExhibitionId",
                        column: x => x.ExhibitionId,
                        principalTable: "Exhibitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "RegistrationToExhibitions",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RegistrationToExhibitions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RegistrationToExhibitions_Advertisements_AdvertisementId",
                        column: x => x.AdvertisementId,
                        principalTable: "Advertisements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RegistrationToExhibitions_Exhibitions_ExhibitionId",
                        column: x => x.ExhibitionId,
                        principalTable: "Exhibitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RegistrationToExhibitions_Exhibitors_ExhibitorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExhibitionDayPrice", x => new { x.ExhibitionDayId, x.PriceId });
                    table.ForeignKey(
                        name: "FK_ExhibitionDayPrice_ExhibitionDays_ExhibitionDayId",
                        column: x => x.ExhibitionDayId,
                        principalTable: "ExhibitionDays",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExhibitionDayPrice_Prices_PriceId",
                        column: x => x.PriceId,
                        principalTable: "Prices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MyWorkflowId = table.Column<int>(type: "integer", nullable: true),
                    PriceTypeWorkflowId = table.Column<int>(type: "integer", nullable: true),
                    RuleIDFK = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyRule", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MyRule_MyRule_RuleIDFK",
                        column: x => x.RuleIDFK,
                        principalTable: "MyRule",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MyRule_MyWorkflows_MyWorkflowId",
                        column: x => x.MyWorkflowId,
                        principalTable: "MyWorkflows",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MyRule_PriceTypeWorkflows_PriceTypeWorkflowId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Cages_RegistrationToExhibitions_RegistrationToExhibitionId",
                        column: x => x.RegistrationToExhibitionId,
                        principalTable: "RegistrationToExhibitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CatRegistrations_RegistrationToExhibitions_RegistrationToEx~",
                        column: x => x.RegistrationToExhibitionId,
                        principalTable: "RegistrationToExhibitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PaymentRequestDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentInfos_RegistrationToExhibitions_RegistrationToExhibi~",
                        column: x => x.RegistrationToExhibitionId,
                        principalTable: "RegistrationToExhibitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PersonRegistrations_RegistrationToExhibitions_RegistrationT~",
                        column: x => x.RegistrationToExhibitionId,
                        principalTable: "RegistrationToExhibitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MyRuleId = table.Column<int>(type: "integer", nullable: true),
                    MyWorkflowId = table.Column<int>(type: "integer", nullable: true),
                    PriceTypeWorkflowId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MyScopedParam", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MyScopedParam_MyRule_MyRuleId",
                        column: x => x.MyRuleId,
                        principalTable: "MyRule",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MyScopedParam_MyWorkflows_MyWorkflowId",
                        column: x => x.MyWorkflowId,
                        principalTable: "MyWorkflows",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MyScopedParam_PriceTypeWorkflows_PriceTypeWorkflowId",
                        column: x => x.PriceTypeWorkflowId,
                        principalTable: "PriceTypeWorkflows",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Parent_ExhibitedCats_ExhibitedCatIsFatherOfId",
                        column: x => x.ExhibitedCatIsFatherOfId,
                        principalTable: "ExhibitedCats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Parent_ExhibitedCats_ExhibitedCatIsMotherOfId",
                        column: x => x.ExhibitedCatIsMotherOfId,
                        principalTable: "ExhibitedCats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Parent_Litters_LitterIsFatherOfId",
                        column: x => x.LitterIsFatherOfId,
                        principalTable: "Litters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Parent_Litters_LitterIsMotherOfId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExhibitionDayPrice_PriceId",
                table: "ExhibitionDayPrice",
                column: "PriceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MyRule_MyWorkflowId",
                table: "MyRule",
                column: "MyWorkflowId");

            migrationBuilder.CreateIndex(
                name: "IX_MyRule_PriceTypeWorkflowId",
                table: "MyRule",
                column: "PriceTypeWorkflowId");

            migrationBuilder.CreateIndex(
                name: "IX_MyRule_RuleIDFK",
                table: "MyRule",
                column: "RuleIDFK");

            migrationBuilder.CreateIndex(
                name: "IX_MyScopedParam_MyRuleId",
                table: "MyScopedParam",
                column: "MyRuleId");

            migrationBuilder.CreateIndex(
                name: "IX_MyScopedParam_MyWorkflowId",
                table: "MyScopedParam",
                column: "MyWorkflowId");

            migrationBuilder.CreateIndex(
                name: "IX_MyScopedParam_PriceTypeWorkflowId",
                table: "MyScopedParam",
                column: "PriceTypeWorkflowId");

            migrationBuilder.CreateIndex(
                name: "IX_MyWorkflows_ExhibitionId",
                table: "MyWorkflows",
                column: "ExhibitionId");

            migrationBuilder.CreateIndex(
                name: "IX_Parent_ExhibitedCatIsFatherOfId",
                table: "Parent",
                column: "ExhibitedCatIsFatherOfId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Parent_ExhibitedCatIsMotherOfId",
                table: "Parent",
                column: "ExhibitedCatIsMotherOfId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Parent_LitterIsFatherOfId",
                table: "Parent",
                column: "LitterIsFatherOfId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Parent_LitterIsMotherOfId",
                table: "Parent",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RegistrationToExhibitions_AdvertisementId",
                table: "RegistrationToExhibitions",
                column: "AdvertisementId");

            migrationBuilder.CreateIndex(
                name: "IX_RegistrationToExhibitions_ExhibitionId_ExhibitorId",
                table: "RegistrationToExhibitions",
                columns: new[] { "ExhibitionId", "ExhibitorId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_RegistrationToExhibitions_ExhibitorId",
                table: "RegistrationToExhibitions",
                column: "ExhibitorId");

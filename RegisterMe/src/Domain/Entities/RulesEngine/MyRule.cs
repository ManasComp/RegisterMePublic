...
public class MyRule
{
    ...
    public MyRule(Rule r)
    {
        ...
        LocalParams = r.LocalParams?.Select(x => new MyScopedParam(x));
        Expression = r.Expression;
        Actions = r.Actions;
        SuccessEvent = r.SuccessEvent;
        Rules = r.Rules?.Select(x => new MyRule(x)).ToList();
    }

    public virtual List<MyRule> Rules { get; init; }
    ...
    public virtual IEnumerable<MyScopedParam> LocalParams { get; init; }

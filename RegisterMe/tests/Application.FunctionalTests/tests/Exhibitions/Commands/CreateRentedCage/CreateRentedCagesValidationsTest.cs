...
public class CreateRentedCagesPricesValidationsTest(DatabaseTypes databaseType) : BaseTestFixture(databaseType)
{
    ...
    public async Task ShouldResultBeTrueValidations(int? count, RentedCageEnum? rentedCage, int? length, int? width,
        int? height, ExhibitionDaysEnum? exhibitionDaysE)
    {
        // Arrange
        string user = await RunAsOndrejAsync();

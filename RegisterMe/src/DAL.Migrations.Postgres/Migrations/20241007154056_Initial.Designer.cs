...
namespace DAL.Migrations.Postgres.Migrations
{
    ...
    [Migration("20241007154056_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ExhibitionDayPrice", b =>
                {
            ...
            modelBuilder.Entity("RegisterMe.Domain.Entities.RegistrationToExhibition", b =>
                {
                    ...
                    b.ToTable("RegistrationToExhibitions");
                });
            ...
            modelBuilder.Entity("RegisterMe.Domain.Entities.RulesEngine.MyRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RegisterMe.Domain.Entities.RulesEngine.MyScopedParam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("MyScopedParam");
                });

            modelBuilder.Entity("RegisterMe.Domain.Entities.RulesEngine.MyWorkflow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("RegisterMe.Domain.Entities.RulesEngine.MyRule", b =>
                {
                    b.HasOne("RegisterMe.Domain.Entities.RulesEngine.MyWorkflow", null)
                        .WithMany("Rules")
                        .HasForeignKey("MyWorkflowId")
                        .OnDelete(DeleteBehavior.Cascade);
                    ...
                    b.HasOne("RegisterMe.Domain.Entities.RulesEngine.MyRule", null)
                        .WithMany("Rules")

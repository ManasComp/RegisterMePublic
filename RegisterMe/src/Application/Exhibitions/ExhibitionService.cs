    ...
    : IExhibitionService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new MultiCurrencyPrice(advertisement.PriceCzk, advertisement.PriceEur);
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            PriceKc = x.Price.PriceCzk,
            PriceEur = x.Price.PriceEur,
        ...
        IQueryable<Exhibition> exhibitionQuery)
    {
        ...
        {
            HashSet<int> exhibitionIds = appContext.RegistrationToExhibitions
    ...
    private async Task<Boolean> AllDaysAreFromGivenExhibition(int exhibitionId, List<PriceDays> priceDays,
